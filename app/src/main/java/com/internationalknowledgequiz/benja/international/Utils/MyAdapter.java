...
import com.internationalknowledgequiz.benja.international.QuestionActivity;
import com.internationalknowledgequiz.benja.international.R;
...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder viewHolder, int i) {
        ...
        Picasso.get().load(listItem.getFlag()).into(viewHolder.imageViewFlag);
